...
// created a ColumnProps for TS => must make sure to define what is being passed in and that it's type is defined correctly
type ColumnProps = {
    title: string,
    links: Array<string>;
}
    ...
    return (
        <footer className='flex-start footer'>
            <div className='flex flex-col gap-12 w-full'><div className='flex items-start flex-col'>
                ...
                <div className='flex flex-wrap gap-12'><FooterColumn title={footerLinks[0].title} links={footerLinks[0].links} />
